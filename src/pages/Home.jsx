...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500/90 via-cyan-500/95 to-teal-400/90 p-12">
      <div className="min-w-4xl mx-auto bg-white/95 rounded-2xl shadow-2xl p-16">
        ...
        <section className="mb-10">
          <h2 className="text-3xl mb-4 text-gray-800">How to use</h2>
        ...
        {/* What's included */}
        <section className="mb-10">
          <h2 className="text-3xl mb-1 text-gray-800">What's in here (more on the way!)</h2>
          <div className="text-gray-700 leading-relaxed mb-6">
            <p className="mb-3">
              The swara circles light up when you hover and get brighter when you play them. Each raga has its proper <i>arohana</i> (ascending) and <i>avarohana</i> (descending) patterns with the right swaras.
            </p>
            <p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl mb-3 text-gray-800">Currently Available Ragas</h3>
            ...
            <div>
              <h3 className="text-2xl mb-3 text-gray-800">Currently Available Instruments</h3>
        ...
        <div className="bg-gradient-to-r from-purple-500/10 to-teal-500/10 border-2 border-cyan-500/30 rounded-lg p-6 mb-10">
          <h3 className="text-xl text-gray-800 mt-0 mb-2">Quick note</h3>
        ...
        <div className="text-center">
          <Link to="/playground">
            <button className="px-12 py-4 text-lg bg-gradient-to-r from-purple-600/90 to-teal-500/90 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200">
              Try it out
            </button>
          </Link>
